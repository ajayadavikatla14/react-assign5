...
const submitHandler=(e)=>{
  ...
  const editFunc=(id)=>{
    ...
    console.log();
    // objState.name=editData[0].name;
    // objState.age=editData[0].age;
    // objState.course=editData[0].course;
    // objState.batch=editData[0].batch; 
    ...
    <>
      {data.toggler ?
        <div className='student' >
          ...
          <StudentBack objPass={myObj}  toggleFunc={toggleFunc} submitHandler={submitHandler} editFunc={editFunc} AddUpdate={AddUpdate} />
        </div>
        : 
